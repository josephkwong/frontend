...
*/
const Header = () => {
  // Extra section - Implement a header show-hide animation depending on the scroll direction
  const headerRef = useRef(null);

  useEffect(() => {
    let prevScrollPosition = window.screenY;
    ...
    // Enable listeners for event 'Scoll'
    window.addEventListener('scroll', handleScoll);

    // Diable listeners for event 'Scoll'
    return () => {
